import {
    ...
    FooterContacts,
    FooterContent,
    FooterCopyRight, FooterNavigation, FooterSocials, SocialsLinks,
    WrapperFooter
        ...
        <WrapperFooter>
            <Container>
                <FooterBody>
                    <FooterContent>
                        <Logo />
                        <FooterCopyRight>© 2023 TheBurger Fast Food Website. All rights reserved. Developed by Vlad</FooterCopyRight>
                    </FooterContent>
                    <FooterNavigation>
                        <FooterContacts>
                            <FooterContact>
