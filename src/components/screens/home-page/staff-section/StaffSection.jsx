import {
    StaffBody,
    StaffCard, StaffCardBody, StaffCardImg,
    StaffCards,
    WrapperStaff
        ...
        <WrapperStaff>
            <Container>
                <StaffBody data-aos="fade-up">
                    ...
                    <Text>At <span>TheBurger</span>, we take pride in delivering a burger experience that goes beyond
                        the ordinary. Our dedicated <span>team of professionals</span> is at the heart of this mission,
                        working tirelessly to ensure every visit to our restaurant is a memorable one.</Text>
                </StaffBody>
                <StaffCards>
