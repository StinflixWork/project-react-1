import {
    AboutBody,
    AboutImage, AboutReasons, ReasonItem,
    WrapperAboutSection
        ...
        <WrapperAboutSection>
            <ContainerFlexRow alignItems='center' gap={70}>
                ...
                <AboutBody>
                    ...
                    <Text>
                        At <span>TheBurger</span>, we&apos;re not just a burger joint; we&apos;re an experience crafted
                        with passion and dedication. When you choose us, you&apos;re choosing more than just a meal;
                        you&apos;re selecting a culinary adventure that will leave your taste buds dancing and your
                        heart content. Here are four compelling reasons why you should make us your go-to burger
                        destination:
                    </Text>
                    <AboutReasons>
