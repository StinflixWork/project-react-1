		...
		<WrapperHero>
			<ContainerFlexRow justify="space-between" gap={25}>
				<HeroBody data-aos="fade-right">
					...
					<Heading1>
						Elevate Your Taste Buds: Welcome to <span>TheBurger</span>!
					</Heading1>
					<Text>
						Step into a world of burger excellence at Burger Haven. Our menu is
						a symphony of flavors, carefully composed to satisfy your cravings.
						Join us for an unforgettable dining experience that celebrates the
						art of the burger. <span>Discover your new favorite today!</span>
					</Text>
					<HeroCards>
						<HeroCard
							icon={DeliveryIcon}
